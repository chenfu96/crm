								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer/add.html" 
														target=main>－ 新增客户</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="customer/list.html"
								...
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman/add.html"
														target=main>－ 新增联系人</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman/list.html"
